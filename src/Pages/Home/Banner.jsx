...
const Banner = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4">
      ...
      {/* swiper Section */}
      <div className="mt-12">
        <h1 className="text-4xl font-bold">{formatStyle("custom_text_2")}</h1>
        <div className="flex flex-col md:flex-row p-5 mt-6 gap-6">
          <div className="md:w-[50%]">
            ...
            >
              <SwiperSlide>
                <img
                  src={`${base_url + landing[0]?.custom_upload_head_text_1}`}
                  alt=""
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src={`${base_url + landing[0]?.custom_upload_head_text_2}`}
                  alt=""
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src={`${base_url + landing[0]?.custom_upload_head_text_3}`}
                  alt=""
                />
              </SwiperSlide>
              <SwiperSlide>
